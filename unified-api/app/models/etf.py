...
class ETF(Base):
    ...
    vol_5y: Mapped[float | None] = mapped_column(Numeric(6, 2))
    ret_risk_1y: Mapped[float | None] = mapped_column(Numeric(6, 2))
    ret_risk_3y: Mapped[float | None] = mapped_column(Numeric(6, 2))
    ret_risk_5y: Mapped[float | None] = mapped_column(Numeric(6, 2))
    max_dd_1y: Mapped[float | None] = mapped_column(Numeric(6, 2))
    max_dd_3y: Mapped[float | None] = mapped_column(Numeric(6, 2))
    max_dd_5y: Mapped[float | None] = mapped_column(Numeric(6, 2))
    max_dd_inception: Mapped[float | None] = mapped_column(Numeric(6, 2))

    index_name: Mapped[str | None] = mapped_column(String(200))
    index_description: Mapped[str | None] = mapped_column(Text)
    investment_focus: Mapped[str | None] = mapped_column(String(200))
    legal_structure: Mapped[str | None] = mapped_column(String(100))
    strategy_risk: Mapped[str | None] = mapped_column(String(50))
    sustainability: Mapped[str | None] = mapped_column(String(200))
    fund_currency: Mapped[str | None] = mapped_column(String(10))
    currency_risk: Mapped[str | None] = mapped_column(String(100))
    distribution_frequency: Mapped[str | None] = mapped_column(String(50))
    fund_provider: Mapped[str | None] = mapped_column(String(200))
    top10_weight: Mapped[float | None] = mapped_column(Numeric(6, 2))
    holdings_in_index: Mapped[int | None] = mapped_column(Integer)
